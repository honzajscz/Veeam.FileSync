    ...
    public class SyncServiceTests
    {
        ...
        public void Matching_file()
        {
            ...
            var dirService = Mock.Of<IDirService>(
                p=>
                    p.GetFilesRecursivelyAsync("Y:\\source") == new []{new SyncFile("source101Hash", "Y:\\source", "01")}.ToAsyncEnumerable() &&
                    p.GetFilesRecursivelyAsync("Y:\\replica") == new []{new SyncFile("source101Hash", "Y:\\replica", "01")}.ToAsyncEnumerable()
                );
        ...
        public void Moved_file()
        {
            ...
            var dirService = Mock.Of<IDirService>(
                p=>
                    p.GetFilesRecursivelyAsync("Y:\\source") == new []{new SyncFile("source101Hash", "Y:\\source", "01")}.ToAsyncEnumerable() &&
                    p.GetFilesRecursivelyAsync("Y:\\replica") == new []{new SyncFile("source101Hash", "Y:\\replica", "02")}.ToAsyncEnumerable()
            );
        ...
        public void Matching_dir()
        {
            ...
            var dirService = Mock.Of<IDirService>(
                p=>
                    p.GetFilesRecursivelyAsync("Y:\\source") == Array.Empty<SyncFile>().ToAsyncEnumerable() &&
                    p.GetFilesRecursivelyAsync("Y:\\replica") == Array.Empty<SyncFile>().ToAsyncEnumerable() &&
                    p.GetDirectoriesRecursively("Y:\\source") == new []{new SyncDir("Y:\\source", "01")}.ToAsyncEnumerable() &&
                    p.GetDirectoriesRecursively("Y:\\replica") == new []{new SyncDir("Y:\\replica", "01")}.ToAsyncEnumerable()
            );
